...
public class GradebookControllerTest {
    ...
    static void beforeAll(){
        ...
        request.addParameter("lastname","Chad");
        request.addParameter("emailAddress","chad.darby@luv2code_school.com");
    ...
    void createStudentHttpRequest() throws Exception{
        ...
        assertNotNull(verifyStudent,"student should be not found");
    ...
    @Test
    void studentInformationDoesNotExistHttpRequest() throws Exception{
    ...
    @Test
    void createANonValidGradeHttpRequestGradeTypeNotExistEmptyResponse()  throws Exception{
